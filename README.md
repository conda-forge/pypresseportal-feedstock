About pypresseportal-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pypresseportal-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pypresseportal-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pypresseportal
# for installing globally
pixi global install pypresseportal
```
...
It is possible to list all of the versions of `pypresseportal` available on your platform:
...
```
pixi search pypresseportal --channel conda-forge
```
